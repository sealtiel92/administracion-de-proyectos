...
INSERT INTO `detalle` VALUES (1,'polo','M','fruit',100,'negra'),(2,'V','M','fruit',100,'blanco');
...
CREATE TABLE `pedido` (
  ...
  KEY `fk_pedido_venta1_idx` (`idventa`),
  KEY `fk_pedido_users1_idx` (`idusers`),
  CONSTRAINT `fk_pedido_users1` FOREIGN KEY (`idusers`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_pedido_venta1` FOREIGN KEY (`idventa`) REFERENCES `venta` (`idventa`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `producto` VALUES (1,'camisa',NULL),(2,'playera',NULL);
...
CREATE TABLE `utiliza` (
  ...
  CONSTRAINT `fk_pedido_has_producto_pedido1` FOREIGN KEY (`idpedido`) REFERENCES `pedido` (`idpedido`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_pedido_has_producto_producto1` FOREIGN KEY (`idproducto`) REFERENCES `producto` (`idproducto`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-04-30 18:06:32
